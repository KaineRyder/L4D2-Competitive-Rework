...
{
    g_hCvarColor = CreateConVar("l4d2_tank_prop_brief_glow_color", "255 0 0", "Prop Glow Color (RGB)", FCVAR_NOTIFY);
    g_hCvarGlowTime = CreateConVar("l4d2_tank_prop_brief_glow_time", "12.0", "How long the glow effect lasts (seconds)", FCVAR_NOTIFY, true, 0.1);
